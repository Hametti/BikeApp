...
\textit
{
	Po stworzeniu projektu poznawaliśmy strukturę oraz działanie aplikacji próbując modyfikować istniejące już klasy. Po zapoznaniu się z podstawami realizowaliśmy dalsze tutoriale\cite{xamarinandroid_getstarted}\cite{xamarinandroid_layouts} aby swobodnie pracować w środowisku Xamarin'a.
}
